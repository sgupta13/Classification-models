...
train1<-read.csv('TrainData2.csv',header = T)
test1<-read.csv('TestData2.csv',header = T)
...
test_pred
write.table(test_pred, "GuptaClassification2.txt")
write.csv(test_pred, file = "GuptaClassification2.csv", row.names = FALSE)
############################################################################################
