...
train1<-read.csv('TrainData3.csv',header = T)
test1<-read.csv('TestData3.csv',header = T)
...
test_pred
write.table(test_pred, "GuptaClassification3.txt")
write.csv(test_pred, file = "GuptaClassification3.csv", row.names = FALSE)
############################################################################################
