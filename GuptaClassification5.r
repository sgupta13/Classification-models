...
train1<-read.csv('TrainData5.csv',header = T)
test1<-read.csv('TestData5.csv',header = T)
...
test_pred
write.table(test_pred, "GuptaClassification5.txt")
write.csv(test_pred, file = "GuptaClassification5.csv", row.names = FALSE)
############################################################################################
